...
let project = "Persimmon2.Adapter"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "This is a library for the Persimmon client."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "This is a library for the Persimmon client. It contains TestCollector, Formatter, Printer, Reporter and TestRunner."

// List of author names (for NuGet package)
let authors = [ "bleis-tift, Gab-km, kekyo, pocketberserker, yukitos" ]

// Tags for your project (for NuGet package)
let tags = "Persimmon F# test testing"

// File system information
let solutionFile  = "Persimmon2.Adapter.sln"
...
let gitName = "Persimmon2.Adapter"
